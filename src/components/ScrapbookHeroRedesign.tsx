  ...
  return (
    <div className="w-full max-w-7xl mx-auto min-h-[680px] lg:min-h-[740px] relative select-none flex flex-col justify-center py-6">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center lg:items-center justify-center relative z-10">
        ...
        <div className="w-full lg:w-[54%] flex flex-col items-start text-left relative z-20">
          ...
          <div className="space-y-3.5 md:space-y-4 w-full">
            ...
            <div className="relative inline-block group">
              ...
              <div className="absolute -top-7 -left-7 w-12 h-12 rounded-full border-2 border-dashed border-[#3B2A22]/40 flex items-center justify-center rotate-[-12deg] pointer-events-none">
                <span className="font-fasthand text-[9px] font-bold text-[#3B2A22]/60 text-center leading-tight">EST. 2024</span>
              </div>
              
              <div className="bg-[#F5EDDC] border-[3px] border-[#3B2A22] px-6 sm:px-8 py-3 sm:py-3.5 shadow-[6px_6px_0_#3B2A22] rounded-lg transform -rotate-[1.8deg] group-hover:-rotate-[2.3deg] group-hover:-translate-y-1 group-hover:shadow-[9px_9px_0_#3B2A22] inline-block transition-all duration-300 ease-out">
                <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-[88px] font-cherry font-bold text-[#3B2A22] tracking-wider leading-none">
                  A NEW
                </h1>
              </div>
            </div>
            ...
            <div className="relative inline-flex items-end z-30 group">
              <div className="bg-[#EF5B5B] border-[3px] border-[#3B2A22] px-6 sm:px-8 py-3 sm:py-3.5 shadow-[6px_6px_0_rgba(59,42,34,0.35)] rounded-md transform rotate-[1.5deg] group-hover:rotate-[2.1deg] group-hover:-translate-y-1 group-hover:shadow-[9px_9px_0_rgba(59,42,34,0.35)] inline-block transition-all duration-300 ease-out">
                <h2 className="text-5xl sm:text-7xl md:text-8xl lg:text-[88px] font-cherry font-bold text-[#F5EDDC] tracking-wider leading-none">
                  TASTE
                </h2>
              </div>

              {/* Hand-placed "OF" Circle Badge overlapping TASTE & Polaroid Seam */}
              <div className="absolute -bottom-4 -right-6 md:-bottom-5 md:-right-8 w-16 h-16 md:w-20 md:h-20 bg-[#FFE066] rounded-full border-[3px] border-[#3B2A22] shadow-[4px_4px_0_rgba(59,42,34,0.3)] flex items-center justify-center z-40 transform rotate-[8deg] group-hover:rotate-[14deg] group-hover:scale-105 transition-transform duration-300 ease-out animate-paper-wobble">
            ...
            <div className="relative inline-block group">
              <div className="bg-[#FAF4E8] border-[3px] border-[#3B2A22] px-6 sm:px-8 py-3 sm:py-3.5 shadow-[6px_6px_0_rgba(59,42,34,0.3)] rounded-xl transform -rotate-[2.5deg] group-hover:-rotate-[3.2deg] group-hover:-translate-y-1 group-hover:shadow-[9px_9px_0_rgba(59,42,34,0.35)] inline-block transition-all duration-300 ease-out">
                <h3 className="text-5xl sm:text-7xl md:text-8xl lg:text-[88px] font-cherry font-bold text-[#3B2A22] tracking-wider leading-none">
                  WELLNESS
                </h3>
              </div>
              {/* Hand-drawn squiggle underline */}
              <svg className="absolute -bottom-3 left-4 w-32 h-6 text-[#3B2A22] opacity-75 pointer-events-none" fill="none" viewBox="0 0 100 24">
          ...
          <p className="text-base md:text-lg text-[#3B2A22] max-w-lg mt-6 leading-[1.75] font-manrope font-medium">
            Guilt-free treats made with better ingredients for{' '}
            <span className="relative inline-block font-fraunces font-bold italic text-[#3B2A22] text-lg md:text-xl">
              a happier you.
          ...
          <div className="mt-6 flex items-center gap-3 font-fasthand text-sm text-[#3B2A22]/75 rotate-[-1deg]">
        ...
        {/* ========================================================================= */}
        <div className="w-full lg:w-[46%] flex justify-center lg:justify-end relative min-h-[480px] sm:min-h-[540px] md:min-h-[580px] z-20 mt-4 lg:mt-0 lg:-ml-12">
          
          {/* Main Cheesecake Polaroid Frame Keepsake */}
          <div className="relative w-80 h-[380px] sm:w-[380px] sm:h-[440px] md:w-[420px] md:h-[480px] lg:w-[450px] lg:h-[510px] bg-white border-[4px] border-[#3B2A22] shadow-[10px_10px_0_#3B2A22] rounded-md p-4 flex flex-col justify-between transform rotate-[2.5deg] hover:rotate-[0.5deg] hover:shadow-[14px_14px_0_#3B2A22] hover:-translate-y-1 transition-all duration-500 ease-out group z-10">
            
            {/* Top Kraft Masking Tape */}
            <MaskingTape color="kraft" width={100} height={32} rotate={-2} className="absolute -top-5 left-1/2 -translate-x-1/2 z-30 opacity-95" />
            ...
            <div className="flex items-center justify-between px-2 pt-2 pb-1">
              ...
              <div className="text-right">
                ...
                <span className="font-fasthand text-[11px] font-bold text-[#EF5B5B]">Made this morning</span>
              </div>
            </div>
          ...
          <div className="absolute -top-4 -right-2 md:-right-6 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-[#7BA3C4] rounded-full border-[3.5px] border-[#3B2A22] shadow-[4px_4px_0_#3B2A22] flex flex-col items-center justify-center z-30 transform rotate-[6deg] animate-paper-wobble">
            <p className="text-[10px] sm:text-xs md:text-sm font-fredoka font-bold text-[#3B2A22] text-center leading-tight uppercase tracking-wider">MADE FRESH</p>
            <p className="text-[10px] sm:text-xs md:text-sm font-fredoka font-bold text-[#3B2A22] text-center leading-tight uppercase tracking-wider">DAILY</p>
          </div>

          {/* Lactose-Free Paper Label (Top Left Polaroid Edge) */}
          <PaperLabel text="LACTOSE-FREE" color="yellow" rotate={-5} className="absolute top-12 -left-4 sm:-left-8 z-30 shadow-[3px_3px_0_#3B2A22] font-fredoka" />

          {/* Sugar-Free Paper Label (Mid-Right Polaroid Edge) */}
          <PaperLabel text="SUGAR-FREE" color="coral" rotate={7} className="absolute top-1/2 -right-4 sm:-right-8 z-30 shadow-[3px_3px_0_#3B2A22] font-fredoka" />

          {/* ------------------------------------------------------------------------- */}
          {/* CLUSTER 2: RECIPE NOTE & MOM'S RECIPE CARD WITH PAPERCLIP & MEASUREMENTS */}
          {/* ------------------------------------------------------------------------- */}
          <div className="absolute bottom-8 -left-6 sm:-left-12 md:-left-16 z-30">
            {/* Paperclip Accent */}
            <svg className="absolute -top-5 left-4 w-6 h-9 text-[#3B2A22] z-40 -rotate-12 pointer-events-none drop-shadow-sm" fill="none" stroke="currentColor" viewBox="0 0 24 32">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 8v14a5 5 0 0010 0V6a3 3 0 00-6 0v14a1 1 0 002 0V8" />
            </svg>
            
            <MaskingTape color="pink" width={52} height={20} rotate={-16} className="absolute -top-3 left-1/2 -translate-x-1/2 z-40" />
            <RecipeCard rotate={-7} edge={1} width={145}>
              <div className="text-center py-1.5 px-1">
                <p className="text-[10px] font-fraunces font-bold text-[#3B2A22]/60 uppercase tracking-widest">
                  Mom&apos;s Recipe #024
                </p>
                <p className="text-base font-fasthand text-[#3B2A22] leading-tight font-bold mt-0.5">
                  Made with love,
                </p>
                <p className="text-sm font-fasthand text-[#EF5B5B] leading-tight font-bold">
                  for you ♡
                </p>
                <p className="text-[10px] font-caveat font-bold text-[#3B2A22]/70 mt-1">250g cream cheese • 100% love</p>
              </div>
            </RecipeCard>
          </div>
          ...
          {/* ------------------------------------------------------------------------- */}
          <div className="absolute -bottom-4 -right-2 sm:-right-6 md:-right-10 w-52 sm:w-56 bg-[#EF9A9A] border-[3px] border-[#3B2A22] shadow-[5px_5px_0_#3B2A22] hover:shadow-[7px_7px_0_#3B2A22] hover:-translate-y-0.5 transition-all duration-300 p-4 rounded-xl transform rotate-[3.5deg] z-30 animate-swing">
            <MaskingTape color="sage" width={56} height={20} rotate={12} className="absolute -top-3 right-4 z-40" />
            <div className="space-y-2">
              {['No Refined Sugar', 'High Protein', 'Real Ingredients', '100% Delicious'].map((label) => (
                <div key={label} className="flex items-center gap-2">
                  <div className="w-4 h-4 bg-white border-2 border-[#3B2A22] rounded flex items-center justify-center shrink-0">
                    <svg className="w-2.5 h-2.5 text-[#3B2A22]" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span className="text-xs font-fredoka font-bold text-[#3B2A22]">{label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="absolute -bottom-8 right-16 z-20">
            <PaperLabel text="HIGH-PROTEIN" color="blue" pill rotate={-2} className="!px-5 !py-2.5 font-manrope font-bold text-xs shadow-[3px_3px_0_#3B2A22]" />
          </div>
