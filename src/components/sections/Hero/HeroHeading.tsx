...
export const HeroHeading: React.FC = React.memo(() => {
  return (
    <div className="HeroHeading relative flex flex-col items-center md:items-start gap-1 sm:gap-2 mb-4 sm:mb-6 w-full transform-gpu text-center md:text-left">
      {/* Torn Paper Strip Mask Layer */}
      <HeroTornPaper />

      {/* Top Banner: "FRESH. HONEST. WHOLESOME." on Warm Paper held by Pink Tape on Left */}
      <div className="relative z-10 -rotate-[2.5deg] mb-1 sm:mb-2 transform-gpu mx-auto md:mx-0">
      ...
      <div className="relative z-10 flex items-center justify-center md:justify-start gap-2 transform-gpu">
      ...
      <div className="relative z-10 flex items-center justify-center md:justify-start -mt-2 sm:-mt-3 transform-gpu">
      ...
      <div className="relative z-10 flex flex-col items-center md:items-start -mt-2 sm:-mt-4 transform-gpu">
        ...
        <svg className="w-40 sm:w-56 h-6 text-[#3D2E25] -mt-1 mx-auto md:mx-0" viewBox="0 0 200 30" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
