  ...
  return (
    <div className="w-full h-full flex flex-col justify-center relative">
      ...
      <div className="flex flex-wrap gap-4 mt-10">
        <button className="px-6 py-3.5 bg-[#EF5B5B] text-white text-sm md:text-base font-bold rounded-lg border-2 border-[#2D1810] shadow-[3px_3px_0_rgba(45,24,16,0.3)] hover:shadow-[4px_4px_0_rgba(45,24,16,0.3)] hover:-translate-y-0.5 hover:bg-[#E54545] transition-all flex items-center gap-3" style={{ fontFamily: "'Fredoka', sans-serif" }}>
        ...
        <button className="px-6 py-3.5 bg-[#F5EDDC] text-[#2D1810] text-sm md:text-base font-bold rounded-lg border-2 border-[#2D1810] shadow-[3px_3px_0_rgba(45,24,16,0.3)] hover:shadow-[4px_4px_0_rgba(45,24,16,0.3)] hover:-translate-y-0.5 transition-all flex items-center gap-3" style={{ fontFamily: "'Fredoka', sans-serif" }}>
